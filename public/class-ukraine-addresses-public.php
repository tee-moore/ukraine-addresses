...
class Ukraine_Addresses_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->ukraine_addresses, plugin_dir_url( __FILE__ ) . 'css/ukraine-addresses-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->ukraine_addresses, plugin_dir_url( __FILE__ ) . 'js/ukraine-addresses-public.js', array( 'jquery' ), $this->version, false );
